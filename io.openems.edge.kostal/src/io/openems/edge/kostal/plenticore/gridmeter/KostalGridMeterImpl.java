...
public class KostalGridMeterImpl extends AbstractOpenemsModbusComponent implements KostalGridMeter, ElectricityMeter,
	...
	private void activate(ComponentContext context, Config config) throws OpenemsException {
		...
		if (super.activate(context, this.config.id(), config.alias(), config.enabled(), config.modbusUnitId(), this.cm,
		...
		if (!this.config.viaInverter()) {
			...
			return new ModbusProtocol(this, //
					new FC3ReadRegistersTask(0, Priority.HIGH, //
							...
							m(KostalGridMeter.ChannelId.ACTIVE_CONSUMPTION_POWER_L1, new UnsignedDoublewordElement(40),
									SCALE_FACTOR_MINUS_1),
							m(KostalGridMeter.ChannelId.ACTIVE_PRODUCTION_POWER_L1, new UnsignedDoublewordElement(42),
									SCALE_FACTOR_MINUS_1),
					...
					// read size too large, 2 attempts required
					new FC3ReadRegistersTask(60, Priority.HIGH, //
							...
							m(KostalGridMeter.ChannelId.ACTIVE_CONSUMPTION_POWER_L2, new UnsignedDoublewordElement(80),
									SCALE_FACTOR_MINUS_1),
							m(KostalGridMeter.ChannelId.ACTIVE_PRODUCTION_POWER_L2, new UnsignedDoublewordElement(82),
									SCALE_FACTOR_MINUS_1),
							...
							m(KostalGridMeter.ChannelId.ACTIVE_CONSUMPTION_POWER_L3, new UnsignedDoublewordElement(120),
									SCALE_FACTOR_MINUS_1),
							m(KostalGridMeter.ChannelId.ACTIVE_PRODUCTION_POWER_L3, new UnsignedDoublewordElement(122),
									SCALE_FACTOR_MINUS_1),
			...
			// KSEM is read directly
			return new ModbusProtocol(this, //
					new FC3ReadRegistersTask(220, Priority.HIGH, //
							m(ElectricityMeter.ChannelId.FREQUENCY, new FloatDoublewordElement(220).wordOrder(LSWMSW),
									SCALE_FACTOR_3), //
							m(ElectricityMeter.ChannelId.CURRENT_L1, new FloatDoublewordElement(222).wordOrder(LSWMSW),
									SCALE_FACTOR_3), //
							...
							m(ElectricityMeter.ChannelId.VOLTAGE_L1, new FloatDoublewordElement(230).wordOrder(LSWMSW),
									SCALE_FACTOR_3), //
							m(ElectricityMeter.ChannelId.CURRENT_L2, new FloatDoublewordElement(232).wordOrder(LSWMSW),
									SCALE_FACTOR_3),
							...
							m(ElectricityMeter.ChannelId.VOLTAGE_L2, new FloatDoublewordElement(240).wordOrder(LSWMSW),
									SCALE_FACTOR_3), //
							m(ElectricityMeter.ChannelId.CURRENT_L3, new FloatDoublewordElement(242).wordOrder(LSWMSW),
									SCALE_FACTOR_3),
